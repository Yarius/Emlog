...
<div class="login-main">
	...
	<div class="checkbox"> <input type="checkbox" name="ispersis" id="ispersis" value="1" /><span><label for="ispersis">Запомнить меня</label></span></div>
	<div class="button"><input type="submit" value=" Войти" class="submit"></div>
	</div>
	<div style=" clear:both;"></div>
	<div class="login-ext"><?php doAction('login_ext'); ?></div>
	<div class="login-bottom"></div>
	<div class="back"><a href="../">&laquo;Вернуться на главную</a> | <a href="http://wiki.emlog.net/doku.php?id=chpwd" target="_blank">Забыли пароль?</a></div>
</div>
<?php if ($error_msg): ?>
