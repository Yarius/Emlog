...
<div class=containertitle><b>Управление виджетами</b>
<?php if(isset($_GET['activated'])):?><span class="actived">Настройки успешно сохранены</span><?php endif;?></div>
<div class=line></div>
...
<div id="adm_widget_list">
	...
	<div class="widget-line" id="blogger">
		<div class="widget-top">
			<li class="widget-title">Обо мне</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li>Заголовок</li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['blogger']; ?>"  /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="calendar">
		<div class="widget-top">
			<li class="widget-title">Календарь</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li>Заголовок</li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['calendar']; ?>"  /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="twitter">
		<div class="widget-top">
			<li class="widget-title">Микроблог</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			...
			<li>Количество сообщений на главной</li>
			<li><input maxlength="5" size="10" value="<?php echo Option::get('index_newtwnum'); ?>" name="index_newtwnum" /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="tag">
		<div class="widget-top">
			<li class="widget-title">Теги</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li>Заголовок</li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['tag']; ?>"  /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="sort">
		<div class="widget-top">
			<li class="widget-title">Категории</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li>Заголовок</li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['sort']; ?>"  /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="archive">
		<div class="widget-top">
			<li class="widget-title">Архив</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li>Заголовок</li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['archive']; ?>"  /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="newcomm">
		<div class="widget-top">
			<li class="widget-title">Последние комментарии</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			...
			<li><input maxlength="5" size="10" value="<?php echo Option::get('comment_subnum'); ?>" name="comment_subnum" /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="newlog">
		<div class="widget-top">
			<li class="widget-title">Последние статьи</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			...
			<li>Количество статей отображаемых на главной</li>
			<li><input maxlength="5" size="10" value="<?php echo Option::get('index_newlognum'); ?>" name="index_newlog" /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="hotlog">
		<div class="widget-top">
			<li class="widget-title">Популярные</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			...
			<li>Количество статей отображаемых на главной</li>
			<li><input maxlength="5" size="10" value="<?php echo Option::get('index_hotlognum'); ?>" name="index_hotlognum" /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="random_log">
		<div class="widget-top">
			<li class="widget-title">Случайные статьи</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			...
			<li>Количество статей отображаемых на главной</li>
			<li><input maxlength="5" size="10" value="<?php echo Option::get('index_randlognum'); ?>" name="index_randlognum" /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="link">
		<div class="widget-top">
			<li class="widget-title">Ссылки</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li>Заголовок</li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['link']; ?>"  /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	...
	<div class="widget-line" id="search">
		<div class="widget-top">
			<li class="widget-title">Поиск</li>
			<li class="widget-act-add"></li>
			<li class="widget-act-del"></li>
		</div>
		<div class="widget-control">
			<li>Заголовок</li>
			<li><input type="text" name="title" value="<?php echo $customWgTitle['search']; ?>"  /> <input type="submit" name="" value="Сохранить" class="submit" /></li>
		</div>
	</div>
	</form>
	<div class="wg_line">Пользовательские компоненты</div>
	<?php
	foreach ($custom_widget as $key=>$val): 
	preg_match("/^custom_wg_(\d+)/", $key, $matches);
	$custom_wg_title = empty($val['title']) ? 'Безымянные компоненты('.$matches[1].')' : $val['title'];
	?>
	...
	<div class="widget-line" id="<?php echo $key; ?>">
		...
		<div class="widget-control">
			...
			<li><input type="submit" name="" value="Сохранить" />
			<span style="margin-left:235px;"><a href="widgets.php?action=setwg&wg=custom_text&rmwg=<?php echo $key; ?>">Удалить</a></span></li>
		</div>
	</div>
	</form>
	<?php endforeach;?>
	<form action="widgets.php?action=setwg&wg=custom_text" method="post">
	<div class="wg_line2"><a href="javascript:displayToggle('custom_text_new', 2);">Создать новый виджет</a></div>
	<div id="custom_text_new">
		<li>Имя компонента</li>
		<li><input type="text" name="new_title" style="width:380px;" value="" /></li>
		<li>Содержимое (поддерживает HTML)</li>
...
if($i == $wgNum):
?>
<option value="<?php echo $i;?>" selected>Боковая панель<?php echo $i;?></option>
<?php else:?>
<option value="<?php echo $i;?>">Боковая панель<?php echo $i;?></option>
<?php endif;endfor;?>
</select>
</p>
<?php endif;?>
...
<?php 
	...
	if($flg && empty($title)){
		...
		$title = 'Безымянные компоненты ('.$matches[1].')';
	}	
	?>
...
<div style="margin:20px 40px;"><input type="submit" value="Сохранить последовательность" class="button" /></div>
<div style="margin:10px 40px;"><a href="javascript: em_confirm(0, 'reset_widget');">Восстановить виджеты и их позиции по умолчани</a></div>
</div>
</form>
</div>
<script>
