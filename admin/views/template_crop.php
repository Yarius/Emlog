...
<div class=containertitle><b>Обрезать изображение</b><?php if(isset($_GET['activated'])):?><span class="actived">Успешное изменение</span><?php endif;?></div>
<div class=line></div>
...
<p class="submit">
	...
	<input type="submit" value="Обрезать и сохранить" /><span style="margin-left:15px;"><a href="./template.php?action=custom-top" >Отменить кадрирование</a> (Страница загружалась，Выбор области не появится, нажмите левую кнопку мыши, чтобы вручную перетаскивать выбор)</span>
</p>
