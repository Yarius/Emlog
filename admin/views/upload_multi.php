...
<div id="media-upload-header">
	<span><a href="javascript:showupload(0);">Вложения</a></span>
	<span id="curtab"><a href="javascript:showupload(1);">Массовая загрузка</a></span>
	<span><a href="javascript:showattlib();">Список файлов （<?php echo $attachnum; ?>）</a></span>
</div>
<?php 
if(true === isIE6Or7()): ?>
<div class="ie_notice">Версия браузера используется слишком устарела, чтобы использовать эту функцию массовой загрузки. Мы рекомендуем вам обновить ваш браузер и перейти на другие браузеры</div>
<?php else:?>
